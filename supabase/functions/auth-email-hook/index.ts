...
const EMAIL_SUBJECTS: Record<string, string> = {
  signup: 'Confirm your SongDoe account',
  invite: "You've been invited to SongDoe",
  magiclink: 'Your SongDoe login link',
  recovery: 'Reset your SongDoe password',
  email_change: 'Confirm your SongDoe email change',
  reauthentication: 'Your SongDoe verification code',
}
...
// Configuration
const SITE_NAME = "SongDoe"
const SENDER_DOMAIN = "notify.songdoe.com"
const ROOT_DOMAIN = "songdoe.com"
const FROM_DOMAIN = "songdoe.com" // Domain shown in From address (may be root or sender subdomain)
...
const SAMPLE_PROJECT_URL = "https://songdoe.com"
    ...
    result = await sendLovableEmail(
      {
        ...
        from: `SongDoe <noreply@${FROM_DOMAIN}>`,
